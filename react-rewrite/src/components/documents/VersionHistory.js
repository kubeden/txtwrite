...
import { Clock, RotateCcw, ChevronRight, ChevronDown, AlertTriangle, Check, X } from 'lucide-react';
...
export default function VersionHistory({ 
  ...
  const groupVersionsByDay = () => {
    ...
    return Object.entries(groups).map(([day, dayVersions]) => ({
      day,
      date: new Date(day),
      versions: dayVersions.sort((a, b) => new Date(b.timestamp) - new Date(a.timestamp))
