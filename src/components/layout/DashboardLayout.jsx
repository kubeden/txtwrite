    ...
    return (
        <div className="flex flex-col h-full bg-brand-light dark:bg-brand-dark max-h-screen">
            ...
            <div className="flex flex-1 overflow-hidden relative">
                    ...
                    <div className="fixed inset-0 bg-black bg-opacity-50 z-40 md:hidden">
                        <div className="mobile-sidebar absolute top-0 left-0 h-full w-3/4 max-w-xs bg-neutral-100 dark:bg-neutral-900 z-50 flex flex-col overflow-y-auto animate-slide-right">
                            ...
                            <div className="p-4 h-full">
                                <h3 className="text-sm font-medium text-neutral-700 dark:text-neutral-400 mb-2">Documents</h3>
                                <FileSidebar
                ...
                <div
                    className={`absolute top-0 left-0 h-full bg-neutral-100 dark:bg-neutral-900 hidden md:flex flex-col border-r-4 border-brand-gray dark:border-brand-dark transition-[width] duration-200 ease-in-out z-20 ${sidebarExpanded ? 'w-64' : 'w-14'}`}
                    ...
                    <div className="flex items-center justify-between pt-4 px-3">
                        <div className="flex items-center justify-between w-full">
                            <div className="flex items-center justify-end sm:pb-0">
                                <div>
                                    <img src="/logo/logo.png" className="w-6 h-6 flex dark:hidden" alt="Logo" />
                                    <img src="/logo/logo-dark.png" className="w-6 h-6 hidden dark:flex" alt="Logo" />
                                </div>
                            </div>

                            {sidebarExpanded && (
                                <div className="flex flex-row items-center justify-between w-full">
                                    <span className={`ml-3 text-neutral-700 dark:text-neutral-300 font-medium ${sidebarExpanded ? 'opacity-100' : 'opacity-0'}`}>
                                        TXTWrite
                                    </span>
                                    <ThemeToggle />
                                </div>
