...
const WelcomeModal = () => {
  ...
  return (
    <div
      className={`fixed inset-0 flex items-center justify-center bg-brand-dark bg-opacity-100 transition-all duration-300 ${
    ...
    >
      <div
        className={`relative border border-neutral-800 bg-neutral-900 w-full h-full overflow-hidden transition-all duration-300 transform ${
          animateOut ? "scale-95 opacity-80" : "scale-100"
        }`}
      >
